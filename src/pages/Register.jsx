  ...
  return (
    <section className="grid lg:grid-cols-2 grid-cols-1 min-h-screen">
      ...
      <main className="h-full flex justify-center items-center relative">
        <Link to={'/'} className="absolute top-1 left-2 p-2 rounded-full bg-blue-700 text-white text-sm flex items-center space-x-2">
        ...
        <form className="sm:w-11/12 mx-auto sm:px-5 w-full px-3">
          ...
          <div className="mt-3 mb-5">
            <h5 className="text-xl px-2">
              Hey dear! <span>&#128075;</span> get started
            </h5>
          </div>
          ...
          <div className="px-2">
            <Input
              ...
              className={
                "border-[1px] border-gray-400 px-3 py-2 w-full rounded-sm text-sm focus:outline-none focus:ring-0"
              }
            />
            <Input
              label={"Email"}
