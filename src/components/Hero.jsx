...
const Hero = () => {
  ...
  return (
    ...
    >
      <h1
        className="text-3xl text-center max-md:text-2xl"
        data-aos="slide-down"
      ...
      <h2
        className="text-xl text-gray-300 text-center mt-2 max-md:text-lg"
        data-aos="slide-up"
        data-aos-duration="1000"
      >
      ...
      <button
        className="mt-4 bg-blue-600 hover:bg-blue-900 transition-all duration-200 py-2 px-4 rounded-lg focus:ring-0 focus:outline-none"
        onClick={openModal}
        data-aos="fade-up"
        data-aos-duration="1000"
      >
